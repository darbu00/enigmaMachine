...
public class EnigmaMachine {
    ...
    public void startEnigma() {
        ...
        //testEncryption(enigmaMachine.getPlugboard(), enigmaMachine.getWheels(), enigmaMachine.getReflector(), enigmaMachine.getEncryptor(), enigmaMachine.getWheelOrder());;q
        //
        ...
        do {
            switch (enigmaState) {
                ...
                case LOAD_ENIGMA:
                    ...
                    try {
                        fileContent = enigmaReader.readFile("/Users/David/Desktop/alphabet.txt");
                    } catch (Exception e) {
...
// This is a test encryption
        ...
        public static void testEncryption (Plugboard plugboard, Wheel[]wheels, Reflector reflector, Encrypt encryptor,
            ...
            for (int i = 0; i < wheelOrder.length; i++) {
                ...
                //System.out.print("Wheel: " + wheelOrder[i] + " " + wheels[wheelOrder[i]].getCurrentWheelPosition() + "   ");
            }
